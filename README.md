...
local Window = OrionLib:MakeWindow({Name = "GringoXd Hub", HidePremium = false, IntroText = "", SaveConfig = true, ConfigFolder = "GringoXd Hub"})
...
W:AddLabel("[+] GringoXd Hub is HERE!")
...
pcall(function()
    while wait() do
        if _G.AutoEliteHunter then
            if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                OrionLib:MakeNotification({
                    Name = "GringoXd Hub(Noitification)",
